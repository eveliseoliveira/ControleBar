...
namespace ControleBar.ConsoleApp.ModuloProduto
{
    public class TelaCadastroProduto : TelaBase, ITelaCadastravel
    {
        ...
        public void Excluir()
        {
            ...
            {
                _notificador.ApresentarMensagem("Nenhum pruduto cadastrado para excluir.", TipoMensagem.Atencao);
                return;
            }
        ...
        public bool VisualizarRegistros(string tipoVisualizacao)
        {
            ...
            if (produtos.Count == 0)
            {
                _notificador.ApresentarMensagem("Nenhum pruduto disponível.", TipoMensagem.Atencao);
                return false;
            }
        ...
        private Produto ObterProduto()
        {
            ...
            Console.Write("Digite a disponibilidade do produto: ");
            string disponibilidade = Console.ReadLine();

            return new Produto(produtonome, preco, disponibilidade);
        }
